...
(
 ...
 CREATE TABLE prosjektDeltagelse --Mellomtabell! Skal det være en FOREGIN key her som går til prosjekt? ALTER TABLE??
(
	...
	CONSTRAINT prosjektId_fk FOREIGN KEY (prosjektId) REFERENCES (prosjekt),
	CONSTRAINT ansattId_fk FOREIGN KEY (ansattId) REFERENCES (ansatt)
);
...
INSERT INTO
prosjekt(prosjektId, prosjektNavn)
VALUES
	(5, 'Ny nettside'),
	(6, 'Nytt database system'),
	(8, 'Smart betaling');
...
VALUES
	(1, 5, 50, 'Prosjekt leder'),	
	(5, 6, 70, 'Leder'),
	(6, 8, 58, 'Prosjekt leder');	
